...
class MediaModel {
    ...
    public function linkToParent(int $mediaId, int $toyId) {
        // Tjek om det er det fÃ¸rste billede, sÃ¥ gÃ¸r vi det automatisk til Main
    ...
    public function linkToChild(int $mediaId, int $itemId) {
        // Tjek om det er det fÃ¸rste billede
    ...
    /**
     * Den komplekse logik: SÃ¦t dette billede som MAIN, og fjern flaget fra alle andre i samme gruppe
     */
    ...
    /**
     * Sletter en medie-fil bÃ¥de fra databasen og fra filsystemet
     */
    public function delete(int $mediaId) {
        ...
        // 3. Slet selve rÃ¦kken i media_files
