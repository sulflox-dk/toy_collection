...
--
-- Vært: 127.0.0.1:3306
-- Genereringstid: 31. 01 2026 kl. 22:00:39
-- Serverversion: 8.4.7
-- PHP-version: 8.3.28
...
CREATE TABLE IF NOT EXISTS `collection_toys` (
  ...
  `acquisition_status` enum('In Hand','Pre-order','Shipped','Paid','Backordered','Customs') COLLATE utf8mb4_unicode_ci DEFAULT 'In Hand',
  ...
  `personal_toy_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `condition` enum('Mint','Near Mint','Good','Fair','Poor','Broken') COLLATE utf8mb4_unicode_ci DEFAULT 'Good',
  `user_comments` text COLLATE utf8mb4_unicode_ci,
  `completeness_grade` enum('Complete','Incomplete','Sealed','Custom') COLLATE utf8mb4_unicode_ci DEFAULT 'Incomplete',
...
CREATE TABLE IF NOT EXISTS `collection_toy_items` (
  ...
  `condition` enum('Mint','Near Mint','Good','Fair','Poor','Broken') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_reproduction` enum('Original','Reproduction','Unknown') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_loose` tinyint(1) DEFAULT '1',
  `personal_item_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `acquisition_status` enum('In Hand','Pre-order','Shipped','Paid','Backordered','Customs') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `expected_arrival_date` date DEFAULT NULL,
  `source_id` int DEFAULT NULL,
  `storage_id` int DEFAULT NULL,
  `purchase_date` date DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `master_toys` (
  ...
  `wave_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `assortment_sku` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `exclusivity_note` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `line_id` (`line_id`),
...
CREATE TABLE IF NOT EXISTS `master_toy_items` (
  ...
  `variant_description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `master_toy_id` (`master_toy_id`),
...
CREATE TABLE IF NOT EXISTS `media_files` (
  ...
  `file_type` enum('Image','PDF','Document','Video') COLLATE utf8mb4_unicode_ci DEFAULT 'Image',
...
CREATE TABLE IF NOT EXISTS `storage_units` (
  `id` int NOT NULL AUTO_INCREMENT,
  `box_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_room` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `subjects` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('Character','Vehicle','Environment','Creature','Accessory','Packaging','Paperwork') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Accessory',
